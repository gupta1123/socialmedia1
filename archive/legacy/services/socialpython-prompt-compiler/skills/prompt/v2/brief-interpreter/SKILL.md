...
- Asset needs
- Poster mode: finished poster, poster-with-reserve, or scene-led reserve
- Style pressure: iconic, editorial, documentary, festive, invitation-led, quote-led, or calm neutral
...
- Separate communication intent from visual style. The brief contract should say what the image must do before style-taxonomy decides how it should look.
- Record any explicit style bias from the brief: dusk, editorial, iconic, emotional, documentary, festive, scarcity-led, invitation-led, or quote-led.
...
- If the brief under-specifies style, leave space for `style-taxonomy` to choose a compatible family instead of inventing generic premium-style prose here.
