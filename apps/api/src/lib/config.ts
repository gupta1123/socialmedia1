...
const EnvSchema = z.object({
  ...
  AI_EDIT_GOOGLE_LOW_MODEL: stringWithDefault("fal-ai/nano-banana/edit"),
  AI_EDIT_GOOGLE_HIGH_MODEL: stringWithDefault("fal-ai/nano-banana-pro/edit"),
  AI_EDIT_OPENAI_MODEL: stringWithDefault("gpt-image-2"),
  CREATE_V3_DEFAULT_RENDER_PRESET: z.enum(["v1_low", "v1_high", "v2_low", "v2_medium", "v2_high"]).default("v2_high"),
  CREATE_V3_ALLOW_CLIENT_RENDER_PRESET: z.enum(["0", "1"]).default("0"),
  CREATE_V3_GOOGLE_LOW_MODEL: stringWithDefault("fal-ai/nano-banana-2/edit"),
  CREATE_V3_GOOGLE_HIGH_MODEL: stringWithDefault("fal-ai/nano-banana-pro/edit"),
  CREATE_V3_OPENAI_MODEL: stringWithDefault("gpt-image-2"),
