...
const EnvSchema = z.object({
  ...
  AI_EDIT_DIRECTOR_TRANSPORT: z.enum(["server", "worker"]).default("server"),
  AI_EDIT_DIRECTOR_SCRIPT: z.string().default("../../services/socialpython/agents/ai_edit_director.py"),
